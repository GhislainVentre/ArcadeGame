    ...
    while(game.state != QUIT) {
        ...
        switch(game.state) {
            ...
            case GAME:
                ...
                // Render turn
                SDL_RenderCopy(renderer, turn_texture, NULL, &turn_rect);
                break;
            case WIN1:
                // Render grille
                render_tokens();
                ...
                // Render rectangle
                SDL_SetRenderDrawColor(renderer, 80, 80, 80, 20);
                SDL_Rect win_rect = {width, height, width, height};
                
                SDL_Color textColor = {255, 255, 255};
            	// render Welcome text
        	    SDL_Surface *textSurface = TTF_RenderText_Solid(font64, "Player 1 Win!!!", textColor);
            ...
            case WIN2:
                ...
                SDL_Rect win_rect2 = {width, height, width, height};
                SDL_RenderFillRect(renderer, &win_rect2);
                // print winner
                SDL_Color textColor1 = {255, 255, 255};
            	SDL_Surface *textSurface2 = TTF_RenderText_Solid(font64, "Player 2 Win !!!", textColor1);
